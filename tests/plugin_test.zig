...
test "node plugin events top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_events_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullEventsTopStatus)[0..@intCast(status_len)];
    try std.testing.expect(std.mem.indexOf(u8, status, "\"module\":\"events\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"mode\":\"top-level-native-events-facade\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"EventEmitter\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"once\":false") != null);

    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_events_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullEventsTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"EventEmitter\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"getEventListeners\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"defaultMaxListeners\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_events_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    const config = (config_ptr orelse return error.NullEventsTopConfig)[0..@intCast(config_len)];
    try std.testing.expect(std.mem.indexOf(u8, config, "\"handleModel\":\"explicit native EventEmitter handle") != null);
    try std.testing.expect(std.mem.indexOf(u8, config, "\"objectModel\":\"not-modeled for JavaScript EventEmitter class instances\"") != null);

    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_events_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
    const feature = (feature_ptr orelse return error.NullEventsTopFeatureSupport)[0..@intCast(feature_len)];
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"EventEmitter\":{\"supported\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"once\":{\"supported\":false") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"addAbortListener\":{\"supported\":false") != null);
}
...
test "node plugin console top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_console_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_console_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullConsoleTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"log\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"error\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"timeEnd\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_console_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_console_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin trace_events top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_trace_events_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullTraceEventsTopStatus)[0..@intCast(status_len)];
    try std.testing.expect(std.mem.indexOf(u8, status, "\"module\":\"trace_events\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"mode\":\"top-level-native-trace-events-facade\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"createTracing\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"Tracing\":false") != null);

    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_trace_events_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullTraceEventsTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"createTracing\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"getEnabledCategories\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"Tracing\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_trace_events_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    const config = (config_ptr orelse return error.NullTraceEventsTopConfig)[0..@intCast(config_len)];
    try std.testing.expect(std.mem.indexOf(u8, config, "\"handleModel\":\"explicit native tracing handle") != null);
    try std.testing.expect(std.mem.indexOf(u8, config, "\"objectModel\":\"not-modeled for JavaScript Tracing class instances\"") != null);

    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_trace_events_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
    const feature = (feature_ptr orelse return error.NullTraceEventsTopFeatureSupport)[0..@intCast(feature_len)];
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"createTracing\":{\"supported\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"Tracing\":{\"supported\":false") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"globalTraceState\":{\"supported\":false") != null);
}

test "node plugin fs top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_fs_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullFsTopStatus)[0..@intCast(status_len)];
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_fs_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullFsTopExports)[0..@intCast(exports_len)];
    ...
    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_fs_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_fs_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin crypto top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_crypto_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullCryptoTopStatus)[0..@intCast(status_len)];
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_crypto_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    ...
    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_crypto_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_crypto_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin util top-level facade helpers" {
    ...
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullUtilTopStatus)[0..@intCast(status_len)];
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_util_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullUtilTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"format\"") != null);
    ...
    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_util_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_util_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
    ...
    var encoded_ptr: ?[*]const u8 = null;
    var encoded_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_util_text_encoder_encode("test msg".ptr, 8, &encoded_ptr, &encoded_len));
    defer _ = plugin.sa_node_plugin_free_buffer(encoded_ptr, encoded_len);
    try std.testing.expectEqualStrings("test msg", (encoded_ptr orelse return error.NullUtilTextEncoderEncode)[0..@intCast(encoded_len)]);
...
test "node plugin process top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_process_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullProcessTopStatus)[0..@intCast(status_len)];
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_process_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_process_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin path top-level facade helpers" {
    ...
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullPathTopStatus)[0..@intCast(status_len)];
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_path_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullPathTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"join\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"parse\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"matchesGlob\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_path_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_path_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin querystring top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_querystring_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullQuerystringTopStatus)[0..@intCast(status_len)];
    try std.testing.expect(std.mem.indexOf(u8, status, "\"module\":\"querystring\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"mode\":\"top-level-native-querystring-facade\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"parse\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"unescapeBuffer\":true") != null);

    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_querystring_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullQuerystringTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"escape\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"stringify\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"decode\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_querystring_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    const config = (config_ptr orelse return error.NullQuerystringTopConfig)[0..@intCast(config_len)];
    try std.testing.expect(std.mem.indexOf(u8, config, "\"parseModel\":\"native query-string parse helper returning flat JSON object fields\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, config, "\"bufferModel\":\"unescapeBuffer returns raw bytes through an explicit buffer helper\"") != null);

    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_querystring_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
    const feature = (feature_ptr orelse return error.NullQuerystringTopFeatureSupport)[0..@intCast(feature_len)];
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"escape\":{\"supported\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"decode\":{\"supported\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"unescapeBuffer\":{\"supported\":true") != null);
}

test "node plugin punycode top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_punycode_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullPunycodeTopStatus)[0..@intCast(status_len)];
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_punycode_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullPunycodeTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"encode\"") != null);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_punycode_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin string_decoder top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_string_decoder_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullStringDecoderTopStatus)[0..@intCast(status_len)];
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_string_decoder_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullStringDecoderTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"StringDecoder\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_string_decoder_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    const config = (config_ptr orelse return error.NullStringDecoderTopConfig)[0..@intCast(config_len)];
    try std.testing.expect(std.mem.indexOf(u8, config, "\"handleModel\":\"explicit native StringDecoder handle allocated with create() and released with free()\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, config, "\"encodingModel\":\"current native implementation exposes a fixed UTF-8-oriented decoder subset rather than full JavaScript encoding selection\"") != null);

    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_string_decoder_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin zlib top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_zlib_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullZlibTopStatus)[0..@intCast(status_len)];
    try std.testing.expect(std.mem.indexOf(u8, status, "\"module\":\"zlib\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"mode\":\"top-level-native-zlib-facade\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"gzipSync\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"createGzip\":false") != null);

    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_zlib_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullZlibTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"gzipSync\"") != null);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_zlib_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin readline top-level facade helpers" {
    ...
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullReadlineTopStatus)[0..@intCast(status_len)];
    ...
    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_readline_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullReadlineTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"createInterface\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"emitKeypressEvents\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"promises\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_readline_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    ...
    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_readline_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
...
test "node plugin net top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_net_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullNetTopStatus)[0..@intCast(status_len)];
    try std.testing.expect(std.mem.indexOf(u8, status, "\"module\":\"net\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"mode\":\"top-level-native-net-facade\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"createConnection\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"Socket\":false") != null);

    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_net_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullNetTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"createConnection\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"BlockList\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"SocketAddress\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_net_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    const config = (config_ptr orelse return error.NullNetTopConfig)[0..@intCast(config_len)];
    try std.testing.expect(std.mem.indexOf(u8, config, "\"socketModel\":\"explicit native TCP or Unix socket handle\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, config, "\"blockListModel\":\"explicit native BlockList handle\"") != null);

    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_net_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
    const feature = (feature_ptr orelse return error.NullNetTopFeatureSupport)[0..@intCast(feature_len)];
...
test "node plugin dtls top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_dtls_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullDtlsTopStatus)[0..@intCast(status_len)];
    try std.testing.expect(std.mem.indexOf(u8, status, "\"module\":\"dtls\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"mode\":\"top-level-native-dtls-facade\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"connect\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"recv\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"handshake\":false") != null);

    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_dtls_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullDtlsTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"listen\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"endpointSnapshot\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"free\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_dtls_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    const config = (config_ptr orelse return error.NullDtlsTopConfig)[0..@intCast(config_len)];
    try std.testing.expect(std.mem.indexOf(u8, config, "\"endpointModel\":\"explicit UDP-backed DTLS-compatible endpoint handle reused from the native QUIC-style endpoint subset\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, config, "\"handshakeModel\":\"not-modeled\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, config, "\"serverModel\":\"not-modeled\"") != null);

    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_dtls_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
    const feature = (feature_ptr orelse return error.NullDtlsTopFeatureSupport)[0..@intCast(feature_len)];
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"connect\":{\"supported\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"send\":{\"supported\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"secureContext\":{\"supported\":false") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"server\":{\"supported\":false") != null);
}
...
test "node plugin tls top level constants and cipher helpers" {
    ...
    const cert_json = "{\"subjectaltname\":\"DNS:api.example.test, DNS:*.example.test\",\"subject\":{\"CN\":\"fallback.test\"}}";
    var identity_ptr: ?[*]const u8 = null;
    var identity_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_tls_check_server_identity("api.example.test", 16, cert_json.ptr, cert_json.len, &identity_ptr, &identity_len));
    defer _ = plugin.sa_node_plugin_free_buffer(identity_ptr, identity_len);
    const identity_json = (identity_ptr orelse return error.NullTlsIdentity)[0..@intCast(identity_len)];
    try std.testing.expect(std.mem.indexOf(u8, identity_json, "\"authorized\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, identity_json, "api.example.test") != null);

    var wildcard_ptr: ?[*]const u8 = null;
    var wildcard_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_tls_check_server_identity("www.example.test", 16, cert_json.ptr, cert_json.len, &wildcard_ptr, &wildcard_len));
    defer _ = plugin.sa_node_plugin_free_buffer(wildcard_ptr, wildcard_len);
    try std.testing.expect(std.mem.indexOf(u8, (wildcard_ptr orelse return error.NullTlsWildcardIdentity)[0..@intCast(wildcard_len)], "\"authorized\":true") != null);

    const ip_cert_json = "{\"ipAddresses\":[\"127.0.0.1\"],\"subjectaltname\":\"IP Address:127.0.0.1\"}";
    var ip_identity_ptr: ?[*]const u8 = null;
    var ip_identity_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_tls_check_server_identity("127.0.0.1", 9, ip_cert_json.ptr, ip_cert_json.len, &ip_identity_ptr, &ip_identity_len));
    defer _ = plugin.sa_node_plugin_free_buffer(ip_identity_ptr, ip_identity_len);
    try std.testing.expect(std.mem.indexOf(u8, (ip_identity_ptr orelse return error.NullTlsIpIdentity)[0..@intCast(ip_identity_len)], "\"authorized\":true") != null);

    var mismatch_ptr: ?[*]const u8 = null;
    var mismatch_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_tls_check_server_identity("bad.other.test", 14, cert_json.ptr, cert_json.len, &mismatch_ptr, &mismatch_len));
    defer _ = plugin.sa_node_plugin_free_buffer(mismatch_ptr, mismatch_len);
    const mismatch_json = (mismatch_ptr orelse return error.NullTlsIdentityMismatch)[0..@intCast(mismatch_len)];
    try std.testing.expect(std.mem.indexOf(u8, mismatch_json, "\"authorized\":false") != null);
    try std.testing.expect(std.mem.indexOf(u8, mismatch_json, "ERR_TLS_CERT_ALTNAME_INVALID") != null);
...
test "node plugin http top-level facade helpers" {
    var status_ptr: ?[*]const u8 = null;
    var status_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_http_status_json(&status_ptr, &status_len));
    defer _ = plugin.sa_node_plugin_free_buffer(status_ptr, status_len);
    const status = (status_ptr orelse return error.NullHttpTopStatus)[0..@intCast(status_len)];
    try std.testing.expect(std.mem.indexOf(u8, status, "\"module\":\"http\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"mode\":\"top-level-native-http1-facade\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"request\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"ClientRequest\":false") != null);

    var exports_ptr: ?[*]const u8 = null;
    var exports_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_http_exports_json(&exports_ptr, &exports_len));
    defer _ = plugin.sa_node_plugin_free_buffer(exports_ptr, exports_len);
    const exports_json = (exports_ptr orelse return error.NullHttpTopExports)[0..@intCast(exports_len)];
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"request\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"createServer\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, exports_json, "\"WebSocket\"") != null);

    var config_ptr: ?[*]const u8 = null;
    var config_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_http_config_json(&config_ptr, &config_len));
    defer _ = plugin.sa_node_plugin_free_buffer(config_ptr, config_len);
    const config = (config_ptr orelse return error.NullHttpTopConfig)[0..@intCast(config_len)];
    try std.testing.expect(std.mem.indexOf(u8, config, "\"maxHeaderSize\":16384") != null);
    try std.testing.expect(std.mem.indexOf(u8, config, "\"agentModel\":\"not-modeled\"") != null);

    var feature_ptr: ?[*]const u8 = null;
    var feature_len: u64 = 0;
    try std.testing.expectEqual(@as(u32, 0), plugin.sa_node_plugin_http_feature_support_json(&feature_ptr, &feature_len));
    defer _ = plugin.sa_node_plugin_free_buffer(feature_ptr, feature_len);
    const feature = (feature_ptr orelse return error.NullHttpTopFeatureSupport)[0..@intCast(feature_len)];
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"createServer\":{\"supported\":true") != null);
...
test "node plugin tls top-level facade helpers" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, status, "\"connect\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, status, "\"checkServerIdentity\":true") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, config, "\"identityModel\":") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"connect\":{\"supported\":true") != null);
    try std.testing.expect(std.mem.indexOf(u8, feature, "\"checkServerIdentity\":{\"supported\":true") != null);
